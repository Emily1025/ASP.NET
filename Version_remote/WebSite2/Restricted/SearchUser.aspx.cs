...
public partial class Restricted_SearchUser : System.Web.UI.Page
{
    ...
    protected void findUser(object sender, EventArgs e)
    {
        ...
        switch (btn.CommandName)
        {
            case "Username":
                //output no record
                string strConn = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + Server.MapPath("/") + "27315789/App_Data/Register.accdb;" + "Persist Security Info=False";
            ...
            case "Email":
                //output no record
                string strConn1 = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + Server.MapPath("/") + "27315789/App_Data/Register.accdb;" + "Persist Security Info=False";
            ...
            case "Country":
                //output no record
                string strConn2 = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + Server.MapPath("/") + "27315789/App_Data/Register.accdb;" + "Persist Security Info=False";
